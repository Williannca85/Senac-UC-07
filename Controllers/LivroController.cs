    ...
    public class LivroController : Controller
    {
        ...
        public IActionResult Listagem(string tipoFiltro, string filtro, string itensPorPagina,int NumDaPagina, int PaginaAtual )
        {
            ...
            if(!string.IsNullOrEmpty(filtro))
            {
                ...
                ViewData["livrosPorPagina"] = (string.IsNullOrEmpty(itensPorPagina) ? 10 :
                Int32.Parse(itensPorPagina));//adicionado após a video aula
                ViewData["PaginaAtual"] = (PaginaAtual!=0 ? PaginaAtual : 1); //adicionado após a video aula
